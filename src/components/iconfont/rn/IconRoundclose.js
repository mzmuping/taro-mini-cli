...
let IconRoundclose = ({ size, color, ...rest }) => {
  return (
...
IconRoundclose.defaultProps = {
  size: 18,
};

IconRoundclose = React.memo ? React.memo(IconRoundclose) : IconRoundclose;

export default IconRoundclose;
